...
```bash
npx @moumen/crust history fetch   # pull snapshots into .perf/
npx @moumen/crust history push    # publish this build's snapshot
```
...
npx @moumen/crust ci main --comment crust-comment.md
